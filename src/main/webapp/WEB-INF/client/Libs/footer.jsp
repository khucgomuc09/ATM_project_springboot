...
<body>
				...
				<div class="footer d-flex">
					<div class="footer-logo">
						<a class="link-home" href="/">
							<div class="logo">
								<img src="../img/common/logo-atm.png" height="87" width="128"
									alt="atm" />
							</div>
						</a>
						<div class="text-logo">
							<span class="company-text">Công ty TNHH 2 thành viên ATM</span>
							<ul>
	...
	<div class="copyright-atm">
		<span><i class="fa fa-copyright" aria-hidden="true"></i>Copyright
			2019 ATM. Design by ATM</span>
	</div>
	<!--footer-->
	<!--back-to-top-->
