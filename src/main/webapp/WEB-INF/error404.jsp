...
<jsp:include page="client/Libs/fragment-header.jsp"></jsp:include>
</head>
<body>
	<!--header-->
			...
			<div class="container">
				<div class="content-error">
					<div class="main-error">
						<div class="img-error">
							<img src="/img/common/404.jpg" height="513" width="767" alt="" />
						</div>

						<div class="right-error">
							<div class="error_title">404 ERROR!</div>
							<div class="error_text">Trang bạn đang tìm kiếm không tồn
								tại. Chúng tôi xin lỗi vì sự bất tiện này.</div>
							<div class="back-home">
								<a href="/" class="error_back"><i class="fa fa-home"
	...
	<!--footer-->
	<jsp:include page="client/Libs/footer-animation.jsp"></jsp:include>
	<!--footer-->
	<!--js--start-->
	<script src="../resources/bootstrap/js/bootstrap.min.js"></script>
	<script src="../resources/js/bs-animation.js"></script>
